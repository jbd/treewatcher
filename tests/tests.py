...
from treewatcher import EventsCallbacks, ThreadedEventsCallbacks, MultiProcessingEventsCallbacks
...
class SerialTestsCallbacks(EventsCallbacks):
    """
...
class TestTreeWatcher(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.callbacks = SerialTestsCallbacks()
    ...
    def _run_helper(self, files_number, dirs_number=0, sublevels=0, timeout=1, loop_iter=1):
        ...
        self.stm.process_events(timeout=timeout, until_predicate=until_predicate, workers=2)


    def _test_helper(self, files_number=0, dirs_number=0, loop=1, timeout=5, sublevels=0, cleanup=False):
        """
